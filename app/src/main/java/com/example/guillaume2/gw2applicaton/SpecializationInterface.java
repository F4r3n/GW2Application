...
public class SpecializationInterface implements View.OnClickListener {
    ...
    public SpecializationInterface(Activity activity, FrameLayout frameLayout) {
        ...
        toolTipLinearLayout = new ToolTipLinearLayout(activity);
        toolTipLinearLayout.addToolTip(new ToolTip()
                .addColor(Color.WHITE)
                .addText("Salut ")
                .addView(frameLayout.findViewById(R.id.t10)));
    ...
    private void getInformationMinor(int id) {
        ...
        toolTipLinearLayout.addToolTip(new ToolTip()
                .addColor(Color.WHITE)
                .addText(info)
                .addView(frameLayout.findViewById(id)));

    }
    private void getInformationMajor(int id) {
        String info;
